    ...
    <div className="home">
      ...
      <div>
        ...
        <div className=" flex">
          ...
          />
          <NewsArticle
            title="Weather Service Confirms Weak Tornado"
            url="https://images.pexels.com/photos/1118873/pexels-photo-1118873.jpeg"
          />
          <NewsArticle
            title="The High Imapact Weather Project"
            url="https://assets.bwbx.io/images/users/iqjWHBFdfxIU/iEfY9Ul7Hbd0/v0/-1x-1.jpg"
          />
        </div>
      </div>
      <footer></footer>
